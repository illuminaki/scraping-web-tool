class RegistersController < ApplicationController
  ...
  def update
    respond_to do |format|
      if @register.update(register_params)
        format.html { redirect_to @register, notice: "Register was successfully updated.", status: :see_other }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to registers_path, notice: "Register was successfully destroyed.", status: :see_other }
  ...
  private
    ...
    def set_register
      @register = Register.find(params.expect(:id))
    end

    # Only allow a list of trusted parameters through.
    def register_params
      params.expect(register: [ :url, :title, :description, :emails, :phones, :social_networks, :website_url, :address, :list_id ])
    end
end
